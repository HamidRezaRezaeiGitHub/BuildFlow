...
/**
 * Temporary ShortSignUpPage for testing the ShortSignUpForm component
 ...
 * - Responsive layout
 */
const ShortSignUpPage: React.FC = () => {
    ...
    const handleFormSubmit = (data: any) => {
        ...
        setSubmitMessage(`Form submitted with email: ${data.email}, name: ${data.firstName} ${data.lastName}`);
    };
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-2xl">Short Sign Up Form Testing</CardTitle>
                            <CardDescription>
                                Test the ShortSignUpForm component with different configurations.
                                This form includes first name and last name fields using the Name component.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t text-sm">
                                ...
                                <div>
                                    <strong>Name:</strong> {formData.firstName || formData.lastName ? `${formData.firstName} ${formData.lastName}`.trim() : 'Empty'}
                                </div>
                                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <ShortSignUpForm
                                ...
                                description="Create your account with personal details to get started"
                        ...
                        <div className="space-y-4">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        ShortSignUpForm in inline mode within a custom container
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <ShortSignUpForm
                                        ...
                                        onFormSubmit={(data) => {
                                            ...
                                            setSubmitMessage(`Inline form submitted: ${data.firstName} ${data.lastName} (${data.email})`);
                                        }}
                                        onSignUpSuccess={() => {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-1">
                                        ...
                                        <li>• Name component integration</li>
...
export default ShortSignUpPage;